...
function printResume() {
  ...
  const options = {
    ...
    windowTitle: `Ben_Carey_resume_${new Date().getFullYear()}`, // override the window title
  };
  // htmlToPdf(resume, options);
}
</script>
<template>
  <div class="m-4 lg:m-16 pill-scroll font-lato">
    <div class="py-8 relative">
      ...
      <div class="">
        <hero msg="I am a systems minded developer with a client focused mindset. I am always questioning and curious
              ...
              :call-to-action="printResume" call-to-action-msg="Print Resume"
        />
        <div ref="resume" id="resume">
          <resume :resume="resume" v-if="!loading"/>
          <div v-else>
